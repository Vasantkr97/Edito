      ...
      <div className='flex items-center lg:justify-between justify-center bg-[#0a0a0f]/80 backdrop-blur-xl p-6 mb-4 rounded-lg'>
        <div className='hidden lg:flex items-center gap-8'>
          <Link href="/" className='flex items-center gap-3 group relative'>
            ...
            <div className='className="relative bg-gradient-to-br from-[#1a1a2e] to-[#0a0a0f] p-2 rounded-xl ring-1
          ...
          <nav className='flex items-center space-x-1'>
            <Link href='/snippets' className='relative group flex items-center gap-2 px-4 py-1.5 rounded-lg text-gray-300 bg-gray-800/50 
